...
deploy_to_staging:
	...
	@${FUJI} deploy \
		...
		--branch staging \
		--cluster staging \
		--environment NEXT_PUBLIC_WEBAPP_URL=${NEXT_PUBLIC_WEBAPP_URL},GOOGLE_LOGIN_ENABLED=true,NEXT_PUBLIC_SLOTS_PROXY_URL=${NEXT_PUBLIC_SLOTS_PROXY_URL},GLOBAL_WEBHOOK_URL=${GLOBAL_WEBHOOK_URL},NEXT_PUBLIC_SENTRY_DSN=${NEXT_PUBLIC_SENTRY_DSN},NEXT_PUBLIC_SENTRY_ENV=${NEXT_PUBLIC_SENTRY_ENV},SENTRY_AUTH_TOKEN=${SENTRY_AUTH_TOKEN} \
